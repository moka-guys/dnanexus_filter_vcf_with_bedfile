...
# Create output directories
 ...
 out_dir_quality=/home/dnanexus/out/quality_filtered_vcf/output && mkdir -p ${out_dir_quality}
# Load docker image
docker load < /home/dnanexus/"${DOCKER_IMAGE_FILE}"
echo "Using docker image ${DOCKER_IMAGE_NAME}"

# Apply quality filtering only (no BED filtering)
...
-O z -o ${out_dir_quality}/"$vcf_file_prefix".qualityfiltered.vcf.gz
